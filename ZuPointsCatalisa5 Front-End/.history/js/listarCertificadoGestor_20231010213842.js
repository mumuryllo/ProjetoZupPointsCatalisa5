function atualizarValidacao(certificadoId, novaValidacao) {
    ...
    const data = { certificado_valido: novaValidacao };
    ...
    .then(response => {
        if (response.ok) {
            ...
            window.location.href = 'listagem_certificados_gestor.html';
        } else {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    .then(response => response.ok ? response.json() : Promise.reject('Falha na requisição'))
    .then(certificados => {
