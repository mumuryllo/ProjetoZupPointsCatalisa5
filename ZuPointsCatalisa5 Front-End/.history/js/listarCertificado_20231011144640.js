document.addEventListener('DOMContentLoaded', function () {
  ...
  fetch(`http://localhost:8080/certificados?colaborador=${userId}`, {
    method: 'GET',
    headers: {
    ...
    .then(certificados => {
      ...
      certificados.forEach(certificado => {
        // Verifique se o certificado pertence ao colaborador logado
        if (certificado.colaborador.id === userId) { // Corrigido para certificado.colaborador.id
