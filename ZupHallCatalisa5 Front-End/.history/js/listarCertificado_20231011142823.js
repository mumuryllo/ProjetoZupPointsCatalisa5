document.addEventListener('DOMContentLoaded', function () {
  ...
  fetch(`http://localhost:8080/certificados`, {
    ...
    .then(certificados => {
      // Filtra os certificados pertencentes ao usuário logado (com base no 'colaborador_id')
      const certificadosDoUsuario = certificados.filter(certificado => certificado.colaborador_id === userId);
